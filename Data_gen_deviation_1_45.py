...
p = 1/4
Data_deiviation_1_46 = []
for k in range(1,46,1):
    for blhe in range(10):
        print(CIforpiCasePiiUnknown(100, k, max(int(k*(p + random.uniform(-k/10,k/10))),0), 0.05))
        Data_deiviation_1_80.append(CIforpiCasePiiUnknown(100, k, int(max(k*(p + random.uniform(-k/10,k/10)),0)), 0.05))
print(Data_deiviation_1_80)